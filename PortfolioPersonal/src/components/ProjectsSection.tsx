  ...
  const projects: Project[] = [
    {
      ...
      demoUrl: "https://gestor-gastos-react-iota.vercel.app/",
    },
    {
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col justify-between">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-semibold text-slate-100">{p.title}</h3>
